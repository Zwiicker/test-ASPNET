...
namespace AT_HenriqueZ.Repository
{
    public class PessoaRepository
    {
        private string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=c:\users\henrique\Documents\Visual Studio 2017\Projects\AT_HenriqueZ\App_Data\Pessoa_db.mdf;Integrated Security=True";
